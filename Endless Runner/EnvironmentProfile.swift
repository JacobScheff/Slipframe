        ...
        case .fogHollow:
            return EnvironmentProfile(
                ...
                palette: EnvironmentPalette(
                    ...
                    fogDensity: 0.85,
                    fogColor: TintColor(r: 0.35, g: 0.38, b: 0.42, a: 0.22),
        ...
        case .ghostGlass:
            return EnvironmentProfile(
                ...
                palette: EnvironmentPalette(
                    ...
                    fogDensity: 0.15,
                    fogColor: TintColor(r: 0.7, g: 0.8, b: 0.9, a: 0.08),
        ...
        case .lowCrawl:
            return EnvironmentProfile(
                ...
                palette: EnvironmentPalette(
                    ...
                    fogDensity: 0.1,
                    fogColor: TintColor(r: 0.15, g: 0.3, b: 0.45, a: 0.1),
        ...
        case .stormPass:
            return EnvironmentProfile(
                ...
                palette: EnvironmentPalette(
                    ...
                    fogDensity: 0.35,
                    fogColor: TintColor(r: 0.3, g: 0.4, b: 0.55, a: 0.12),
        ...
        case .crystalCave:
            return EnvironmentProfile(
                ...
                palette: EnvironmentPalette(
                    ...
                    ambienceBrightness: 0.9,
                    fogDensity: 0.12,
                    fogColor: TintColor(r: 0.45, g: 0.25, b: 0.65, a: 0.1),
